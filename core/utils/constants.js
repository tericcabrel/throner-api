...
export const DB_CONNECTION_SUCCESS = 'Connected to db !';
...
export const RESET_PASSWORD_SUCCESS = 'password has been reset.';
export const RESET_PASSWORD_FAILED = 'Error occurs when reset password.';
export const RESET_PASSWORD_EXPIRED = 'Email token has been expired';
export const MAIL_FAILED = 'Error occurs when sending mail.';
export const MAIL_SUCCESS = 'Kindly check your email for further instructions';
